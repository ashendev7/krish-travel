      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <span className="text-3xl font-bold uppercase tracking-tighter block">
              Krish<span className="text-primary">Travel</span>
            </span>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com/krishtravelers?igsh=eTR2bmZvendyZGxq" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary transition-colors">
        ...
        <div className="pt-8 border-t border-white/10 text-center md:flex md:justify-between md:items-center text-zinc-500 text-sm">
          <p>&copy; {new Date().getFullYear()} Krish Travel & Transportation. All rights reserved.</p>
