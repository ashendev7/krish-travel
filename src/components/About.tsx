        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              With over 20 years of experience, Travique has built a strong reputation for reliability, professionalism, and exceptional service in the travel industry.
            </p>
